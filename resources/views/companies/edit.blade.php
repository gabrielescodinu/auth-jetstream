        ...
        <form action="{{ route('companies.update',$company->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <label class="block mb-4">
                    <img class="h-16 w-auto" src="{{ url('storage/'.$company->image) }}" alt="" title="" />
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="category">
                        <option value="" {{ $company->category == 'Uncategorized' ? 'selected' : '' }}>Uncategorized</option>
                        <option value="lorem" {{ $company->category == 'lorem' ? 'selected' : '' }}>Lorem</option>
                        <option value="ipsum" {{ $company->category == 'ipsum' ? 'selected' : '' }}>Ipsum</option>
                    </select>
                </div>
